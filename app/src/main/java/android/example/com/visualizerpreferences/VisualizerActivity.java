...
public class VisualizerActivity extends AppCompatActivity implements  SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void defaultSetup() {
        ...
        boolean boss = sharedPreferences.getBoolean(getString(R.string.pref_show_bass_key),
                getResources().getBoolean(R.bool.pref_show_bass_default));

        mVisualizerView.setShowBass(boss);
    ...
    private void loadSizeFromSharePrefeences(SharedPreferences sharedPreferences){
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_show_bass_key))){
            ...
            loadSizeFromSharePrefeences(sharedPreferences);
        }
